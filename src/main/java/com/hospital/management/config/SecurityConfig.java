    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/patient/list").hasAnyAuthority("ROLE_DOCTOR","ROLE_ADMIN", "ROLE_STAFF")
                        .requestMatchers("/patient/dashboard").hasAnyAuthority("ROLE_PATIENT","ROLE_ADMIN", "ROLE_STAFF")
                        .requestMatchers("/patient/**").hasAnyAuthority("ROLE_ADMIN", "ROLE_STAFF")
                        .requestMatchers("/staff/**").hasAnyAuthority("ROLE_STAFF", "ROLE_ADMIN")
                        .requestMatchers("/appointment/list").hasAnyAuthority("ROLE_DOCTOR","ROLE_ADMIN", "ROLE_STAFF")
